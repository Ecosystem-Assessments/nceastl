...
fig_contribution <- function() {
 ...
 grtot <- grtot[4:1,]
  ...
  img <- png::readPNG('./img/PhyloPic.ce70490a.Chris-huh.Balaenoptera-novaeangliae.png', native = T)
  ...
  img <- png::readPNG('./img/PhyloPic.f1367ab1.Xavier-Giroux-Bougard.Delphinapterus_Delphinapterus-leucas_Monodontidae.png', native = T)
  ...
  img <- png::readPNG('./img/PhyloPic.bba1800a.Milton-Tan.Gadariae_Gadidae_Gadiformes_Gadinae_Gadus_Gadus-morhua_Zeiogadaria.png', native = T)
  ...
  img <- png::readPNG('./img/Phylopic_hippoglossoides.png', native = T)
  ...
  img <- png::readPNG('img/Phylopic_shrimp.png', native = T)
  ...
  # No changes were made
  img <- png::readPNG('./img/PhyloPic.ce70234a.Harold-N-Eyster.Epialtidae_Epialtinae_Majoidea_Pugettia_Pugettia-producta.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/
  # No changes were made
  img <- png::readPNG('img/Phylopic_lobster.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/
  # No changes were made
  img <- png::readPNG('img/Phylopic_actinauge.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/ 
  # No changes were made
  img <- png::readPNG('img/Phylopic_pennatula.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/ 
  # No changes were made
  img <- png::readPNG('img/Phylopic_cyanea_capillata.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/ 
  # No changes were made
  img <- png::readPNG('img/Phylopic_holothuria.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/ 
  # No changes were made
  img <- png::readPNG('img/Phylopic_asteroidea.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/ 
  # No changes were made
  img <- png::readPNG('img/Phylopic_strongylocentrotus.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/ 
  # No changes were made
  img <- png::readPNG('img/Phylopic_scallop.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/
  # No changes were made
  img <- png::readPNG('img/Phylopic_buccinidae.png', native = T)
  ...
  # License: https://creativecommons.org/publicdomain/zero/1.0/
  # No changes were made
  img <- png::readPNG('img/Phylopic_astarte.png', native = T)
